...
class TestAudioUploadEndpoint:
    ...
    def test_upload_empty_file(self, client):
        ...
        empty_file = ("", BytesIO(b""), "application/octet-stream")
    ...
    def test_upload_invalid_format(self, client, invalid_format_file):
        ...
        response = client.post(
            "/api/v1/audio/upload",
            files={"file": invalid_format_file}
        )
    ...
    @patch("app.core.settings.settings.max_upload_size", 1024)  # 1KB limit for test
    ...
    @patch("app.services.upload.upload_service.process_upload")
    def test_request_id_in_response(self, mock_process_upload, client, valid_audio_file):
